        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              At Nazia's Attire, we believe in honoring the rich tradition of
              Pakistani fashion while embracing contemporary style. Our
              collection features carefully crafted pieces that celebrate the
              beauty and elegance of Pakistani women.
            </p>
